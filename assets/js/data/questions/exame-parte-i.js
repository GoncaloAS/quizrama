...
const Q_EXAME_PARTE_I = [
  [
    ...
    1,
    "<b>(B) ✓ correcta:</b> fp1 está em modo \"r\", fp2 em modo \"w\" (que trunca). Lê de fp1, escreve em fp2 → o segundo ficheiro fica com o conteúdo do primeiro.\n\n<b>(A) ✗</b>: lê-se de fp1 (1º) e escreve-se em fp2 (2º) — não substitui o 1º.\n\n<b>(C) ✗</b>: \"w\" trunca o destino, não concatena. Concatenar requer \"a\".",
  ...
  [
    ...
    0,
    "<b>(A) ✓ correcta:</b> fp1 está em \"w\" (truncado) e fp2 em \"r\". Lê de fp2, escreve em fp1 → o primeiro fica com o conteúdo do segundo.\n\n<b>(B) ✗</b>: invertido — fp1 é destino.\n\n<b>(C) ✗</b>: \"w\" trunca, não concatena.",
