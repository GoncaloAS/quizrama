...
const Q_TREINO_FORK = [
  [
    ...
    1,
    "<b>(B) 8 ✓ correcta:</b> três <code>fork()</code> sequenciais — cada um duplica o número de processos. Início: 1 proc → após 1º fork: 2 → 2º fork: 4 → 3º fork: 8. Fórmula: <b>2ⁿ</b> onde n = nº de forks. Logo 2³ = <b>8</b>.\n\n<b>(A) ✗</b>: 3 é o número de chamadas <code>fork()</code>, não de processos.\n<b>(D) ✗</b>: 6 não corresponde a nenhuma operação razoável aqui.\n<b>(C) ✗</b>: 16 = 2⁴ corresponderia a 4 forks.",
  ...
  [
    ...
    1,
    "<b>(B) 16 ✓ correcta:</b> em cada iteração do loop, <i>todos</i> os processos existentes chamam <code>fork()</code> — duplicando o total. 1 → 2 → 4 → 8 → 16. Após 4 iterações: <b>2⁴ = 16</b>.\n\n<b>(C) ✗</b>: 4 é o número de iterações, não de processos.\n<b>(A) ✓ pegadinha</b>: 5 confunde \"iterações + 1\".\n<b>(D) ✗</b>: 8 = 2³ corresponderia a 3 forks.",
  ...
  [
    ...
    2,
    "<b>(C) 5 ✓ correcta:</b> o <code>break</code> só executa no <i>filho</i> (que recebe <code>fork()==0</code>) — impede que o filho continue o loop. Apenas o pai itera 5 vezes, criando <b>5 filhos</b>. Total processos: 1 (pai) + 5 (filhos) = 6.\n\n<b>(A) ✗</b>: 4 ignoraria uma das iterações.\n<b>(B) ✗</b>: 6 é o total de processos, não só de filhos.\n<b>(D) ✗</b>: 32 = 2⁵ seria sem o <code>break</code>.",
  ...
  [
    ...
    0,
    "<b>(A) 4 ✓ correcta:</b> dois forks sequenciais → 2² = 4 processos. Cada um executa a instrução <code>printf</code> uma vez. Total: <b>4 linhas \"hello\"</b>.\n\n<b>(C) ✗</b>: 2 seria só com 1 fork.\n<b>(B) ✗</b>: 3 não corresponde a nenhuma fórmula 2ⁿ.\n<b>(D) ✗</b>: 8 = 2³ seria com 3 forks.",
  ...
  [
    ...
    0,
    "<b>(A) 3 ✓ correcta:</b> trace:<br>1) Processo A faz primeiro fork → A, B. A.pid &gt; 0; B.pid = 0.<br>2) A: <code>pid &gt; 0</code> é <i>verdadeiro</i> → entra no <code>if</code> e faz fork → cria C.<br>3) B: <code>pid &gt; 0</code> é <i>falso</i> (pid = 0) → salta o <code>if</code>.<br>Total: A + B + C = <b>3 processos</b>.\n\n<b>(C) ✗</b>: 2 ignoraria o segundo fork.\n<b>(D) ✗</b>: 4 seria se ambos entrassem no <code>if</code>.\n<b>(B) ✗</b>: 5 não corresponde.",
  ...
  [
    ...
    3,
    "<b>(D) 6 ✓ correcta:</b> trace:<br>1) Após 1º fork: 2 processos. Ambos fazem <code>printf(\"a\")</code> → 2 \"a\"s.<br>2) Após 2º fork: 4 processos. Todos fazem <code>printf(\"b\")</code> → 4 \"b\"s.<br>Total: 2 + 4 = <b>6 caracteres</b>.\n\n<b>(C) ✗</b>: 4 contaria só os \"b\"s.\n<b>(B) ✗</b>: 8 seria 4×2 (errado).\n<b>(A) ✗</b>: 12 não corresponde.",
  ...
  [
    ...
    1,
    "<b>(B) 4 ✓ correcta:</b> trace:<br>1) Processo A faz primeiro fork → A, B. A.fork() ≠ 0; B.fork() = 0.<br>2) A: condição falsa → entra no <code>else</code>, fork → cria C.<br>3) B: condição verdadeira → entra no <code>if</code>, fork → cria D.<br>Total: A + B + C + D = <b>4 processos</b>.\n\n<b>(C) ✗</b>: 2 ignoraria os forks no <code>if</code>/<code>else</code>.\n<b>(A) ✗</b>: 3 seria sem um dos ramos.\n<b>(D) ✗</b>: 8 não corresponde.",
